...
import { GoldGlitterRain } from "../components/GoldGlitterRain";
import { InvitationContent } from "../components/InvitationContent";
import {
  preloadWeddingInvitationFrames,
  preloadWeddingInvitationHero,
  WEDDING_INVITATION_CINEMATIC_URLS,
} from "../data/weddingFrameAssets";
import "../styles/wedding-frame.css";
  ...
  return (
    <main
      className={[
        ...
        showInvitation ? "wif-page--with-invitation" : "",
      ]
        .filter(Boolean)
        .join(" ")}
    >
      ...
      {showInvitation && (
        <div
          ...
          className={[
            ...
            .join(" ")}
        >
          <div className="wif-invitation-shell__glitter" aria-hidden>
            <GoldGlitterRain variant="card" />
          </div>
