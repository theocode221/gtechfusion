...
const INVITATION_MUSIC_URL = publicUrl("images/wedding-frame/song.mp3");
const INVITATION_MUSIC_VOLUME = 0.42;

/** Routes where invitation BGM may continue (Laravel: only this React page is mounted). */
const ROUTES_ALLOW_INVITATION_BGM = new Set(["/jemputan-frame"]);
