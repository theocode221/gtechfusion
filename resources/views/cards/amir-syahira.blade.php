...
<title>Amir & Syahira — Wedding Invitation</title>
...
<div class="nav-drawer" id="navDrawer">
  <div class="nav-header">
    <div class="nav-header-names">Amir & Syahira</div>
    <div class="nav-header-date">✦ 15 November 2025 ✦</div>
  </div>
  <div class="nav-items">
  ...
  <div class="nav-footer">Amir & Syahira Wedding · 2025</div>
</div>
...
<div id="envelopePage">
  ...
  <div class="envelope-wrap" id="envelopeWrap" onclick="openEnvelope()">
    ...
    <div class="env-top-text">
      ...
      <div class="env-invited-sub">✦ Amir &amp; Syahira ✦</div>
    </div>
...
<div id="cardPage">
  ...
  <div id="sec-cover" class="card-cover">
    ...
    <div class="cover-content">
      ...
      <div class="cover-names">Amir <span class="cover-amp">&</span> Syahira</div>
      <div class="cover-divider"><span>✦</span></div>
      <div class="cover-subtitle lang-el" data-en="Together with their families,<br>invite you to celebrate their union" data-my="Bersama keluarga menjemput anda<br>meraikan perkahwinan mereka">Together with their families,<br>invite you to celebrate their union</div>
      <div class="countdown">
  ...
  <div id="sec-invite" class="card-section s1 reveal">
    ...
    <div class="invite-card reveal rd1">
      ...
      <div class="invite-parents">Encik Ahmad bin Hassan<br>&amp; Puan Rohani binti Yusof</div>
      <div class="invite-connector lang-el" data-en="— together with —" data-my="— berserta —">— together with —</div>
      <div class="invite-parents">Encik Rahim bin Ismail<br>&amp; Puan Norzila binti Abdullah</div>
      <div class="floral-div" style="margin:1rem 0;"><span>🌿</span></div>
      <div class="invite-body lang-el" data-en="cordially invite you to the wedding reception of their beloved children" data-my="dengan penuh hormat menjemput anda ke majlis perkahwinan anak-anak mereka yang dikasihi">cordially invite you to the wedding reception of their beloved children</div>
    </div>
  </div>
  ...
  <div id="sec-details" class="card-section s2 reveal">
    ...
    <div class="detail-cards">
      <div class="detail-card reveal rd1">
        ...
        <div class="d-info"><div class="d-label">Date</div><div class="d-value">Saturday, 15 November 2025</div><div class="d-sub">17 Jamadil Awal 1447H</div></div>
      </div>
      <div class="detail-card reveal rd2">
        <div class="d-icon">🕐</div>
        <div class="d-info"><div class="d-label">Time</div><div class="d-value">11:00 AM — 4:00 PM</div><div class="d-sub">Lunch Reception</div></div>
      </div>
      <div class="detail-card reveal rd3">
        <div class="d-icon">🏛️</div>
        <div class="d-info"><div class="d-label">Venue</div><div class="d-value">Dewan Seri Mawar</div><div class="d-sub">No. 12, Jalan Bahagia, Johor Bahru</div></div>
      </div>
      <div class="detail-card reveal">
        <div class="d-icon">👗</div>
        <div class="d-info"><div class="d-label">Dress Code</div><div class="d-value">Pastel Green &amp; Soft Pink</div></div>
      </div>
    </div>
    <a href="https://maps.google.com/?q=Dewan+Seri+Mawar+Johor+Bahru" target="_blank" class="map-btn reveal">
  ...
  <div id="sec-story" class="card-section s3 reveal">
    ...
    <div class="story-timeline reveal rd1">
      <div class="story-item">
        <div class="story-dot-col"><div class="story-dot" style="background:var(--rose-light);box-shadow:0 0 0 2px var(--rose-light);"></div><div class="story-line"></div></div>
        <div><div class="story-year">2019</div><div class="story-title">First Meeting ✨</div><div class="story-desc">We first crossed paths at a mutual friend's gathering in Johor Bahru. A simple hello turned into a three-hour conversation under the stars.</div></div>
      </div>
      <div class="story-item">
        <div class="story-dot-col"><div class="story-dot" style="background:var(--sage-light);box-shadow:0 0 0 2px var(--sage-light);"></div><div class="story-line"></div></div>
        <div><div class="story-year">2020</div><div class="story-title">Through the Pandemic 🌧️</div><div class="story-desc">Distance and lockdowns couldn't keep us apart. Video calls, voice notes and handwritten letters kept our love alive and growing stronger.</div></div>
      </div>
      <div class="story-item">
        <div class="story-dot-col"><div class="story-dot" style="background:var(--gold-light);box-shadow:0 0 0 2px var(--gold-light);"></div><div class="story-line"></div></div>
        <div><div class="story-year">2022</div><div class="story-title">The Proposal 💍</div><div class="story-desc">On a quiet evening at Danga Bay, surrounded by fairy lights and her favourite flowers, he got down on one knee. She said yes before he finished the sentence.</div></div>
      </div>
      <div class="story-item">
        <div class="story-dot-col"><div class="story-dot" style="background:var(--rose);box-shadow:0 0 0 2px var(--rose);"></div></div>
        <div><div class="story-year">2025</div><div class="story-title">Forever Begins 🌸</div><div class="story-desc">And now, we invite you to witness the beginning of our forever. Thank you for being part of this beautiful chapter of our lives.</div></div>
      </div>
    </div>
    ...
    <div style="margin-top:2rem;">
      ...
      <div class="gallery-grid">
        <div class="gallery-item g-full reveal"><div class="g-bg" style="background:linear-gradient(135deg,#f5e0e8,#e8eff5);"></div><div class="g-ph"><span>🌸</span><span>Photo coming soon</span></div></div>
        <div class="gallery-item g-half reveal rd1"><div class="g-bg" style="background:linear-gradient(135deg,#e8f2e9,#f5e8ef);"></div><div class="g-ph"><span>🌿</span></div></div>
        <div class="gallery-item g-half reveal rd2"><div class="g-bg" style="background:linear-gradient(135deg,#fdf0e8,#f5e8ef);"></div><div class="g-ph"><span>💐</span></div></div>
      </div>
    </div>
  </div>
  ...
  <div id="sec-rsvp" class="card-section s4 reveal">
    ...
    <p class="section-sub lang-el" data-en="Kindly RSVP by 1st November 2025" data-my="Sila sahkan kehadiran sebelum 1 November 2025">Kindly RSVP by 1st November 2025</p>
    ...
    <div class="rsvp-stats reveal rd2">
      <div class="stat-card" style="border:1px solid rgba(122,158,126,0.22);">
        <div class="stat-num" style="color:var(--sage);">142</div>
        <div class="stat-label">Attending</div>
      </div>
      <div class="stat-card" style="border:1px solid rgba(200,102,122,0.18);">
        <div class="stat-num" style="color:var(--rose);">18</div>
        <div class="stat-label">Declined</div>
      </div>
      <div class="stat-card" style="border:1px solid rgba(201,168,76,0.18);">
        <div class="stat-num" style="color:var(--gold);">300</div>
  ...
  <div id="sec-wishes" class="card-section s5 reveal">
    ...
    <div class="wishes-scroll" id="wishesList">
      <div class="wish-item"><div class="wish-name">Sarah &amp; Family 🌷</div><div class="wish-text">Wishing you both a lifetime of happiness, laughter and endless love. May your home always be filled with joy!</div></div>
      <div class="wish-item"><div class="wish-name">Uncle Rahman 🤲</div><div class="wish-text">Congratulations, Amir &amp; Syahira! May Allah bless your marriage and grant you a beautiful life together. Ameen.</div></div>
      <div class="wish-item"><div class="wish-name">Kak Ina &amp; Family 💐</div><div class="wish-text">So happy to witness this beautiful union. You two are truly made for each other. Semoga kekal hingga jannah!</div></div>
      <div class="wish-item"><div class="wish-name">Bestie Squad 🌸</div><div class="wish-text">From our first hangout to your big day — we are so proud of you both. Here's to forever! 🥂</div></div>
    </div>
  ...
  <div id="sec-gift" class="card-section s1 reveal">
    ...
    <div class="angpau-cards">
      <div class="angpau-card reveal rd1">
        ...
        <div class="ap-info"><div class="ap-name">Touch 'n Go eWallet</div><div class="ap-num">012-345 6789 · Amir Hafizi</div></div>
        <button class="copy-btn" onclick="copyNum('0123456789',this)">Copy</button>
      </div>
      <div class="angpau-card reveal rd2">
        <div class="ap-icon" style="background:rgba(255,180,0,0.1);">🏦</div>
        <div class="ap-info"><div class="ap-name">Maybank2u</div><div class="ap-num">1234 5678 9012 · Amir Hafizi</div></div>
        <button class="copy-btn" onclick="copyNum('123456789012',this)">Copy</button>
      </div>
      <div class="angpau-card reveal rd3">
        <div class="ap-icon" style="background:rgba(100,100,255,0.08);">💜</div>
        <div class="ap-info"><div class="ap-name">DuitNow / QR Pay</div><div class="ap-num">Scan QR · All banks supported</div></div>
        <button class="copy-btn" onclick="showToast('QR coming soon! 📱')">QR</button>
      </div>
    </div>
  </div>
  ...
  <div class="card-closing reveal">
    ...
    <div class="closing-content">
      ...
      <div class="closing-names">Amir &amp; Syahira</div>
...
function startCountdown(){
  const wd=new Date('2025-11-15T11:00:00');
...
// ══ RSVP
let aChoice='';
function selectAttend(v){aChoice=v;document.getElementById('btnYes').classList.toggle('selected',v==='yes');document.getElementById('btnNo').classList.toggle('selected',v==='no');document.getElementById('paxGroup').style.display=v==='yes'?'block':'none';}
function submitRSVP(){
  ...
  showToast(`Thank you, ${n}! 💌 RSVP received!`);
  document.getElementById('rsvpName').value='';document.getElementById('rsvpPhone').value='';
  aChoice='';document.getElementById('btnYes').classList.remove('selected');document.getElementById('btnNo').classList.remove('selected');document.getElementById('paxGroup').style.display='none';
}

// ══ WISHES
function submitWish(){
  const n=document.getElementById('wishName').value.trim();const t=document.getElementById('wishText').value.trim();
  if(!n||!t){showToast('Please fill in all fields');return;}
  const it=document.createElement('div');it.className='wish-item';it.innerHTML=`<div class="wish-name">${esc(n)}</div><div class="wish-text">${esc(t)}</div>`;
...
// ══ COPY
function copyNum(t,btn){navigator.clipboard.writeText(t).then(()=>{const o=btn.textContent;btn.textContent='✓';btn.classList.add('copied');setTimeout(()=>{btn.textContent=o;btn.classList.remove('copied');},2000);showToast('Copied! 📋');});}
...
// ══ MUSIC
let mOn=false;
function toggleMusic(){mOn=!mOn;const b=document.getElementById('musicBtn');b.textContent=mOn?'♫':'♪';b.classList.toggle('playing',mOn);showToast(mOn?'Music on 🎵':'Music off');}
</script>
</body>
</html>